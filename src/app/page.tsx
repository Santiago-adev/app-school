        ...
        return (
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-20">
              <h1 className="text-6xl font-extrabold text-blue-900 mb-8 leading-tight">
            ...
            <div className="grid md:grid-cols-3 gap-10 mb-20">
              {/* Tarjeta de Colegios */}
              <div className="bg-white p-10 rounded-3xl shadow-2xl border border-blue-100 hover:shadow-3xl transition-shadow duration-300">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-4xl shadow-2xl overflow-hidden">
              <div className="px-10 py-16 sm:p-20">
                <h2 className="text-4xl font-bold text-white mb-12">¿Cómo comenzar?</h2>
